...
int unicode_codepoint_width(uint32_t cp) {
    ...
    /* Combining marks, formatting controls, and zero-width spaces */
    ...
    /* East Asian Wide / Fullwidth blocks & common emojis */
